...
- **Palette colorblind-safe (Okabe-Ito)** (doc. 1, punto 11): **implementata**, in entrambe le viste, con la stessa attenzione a differenziare anche per luminosità/spessore oltre che per tonalità. In aggiunta, i nodi del layer Network nel grafo 3D presentano ora una nuova colorazione.
